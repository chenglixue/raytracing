...
namespace ray_tracing
{
	...
	{
		//Print  samples when debugging. To enable, set enableDebug true.
		...
		if (boundary->hit(r, rec1.t + 0.0001, infinity, rec2) == false)
		{
			return false;
		}
		...
		if (debugging == true)
		{
			std::cerr << std::endl << "t0 = " << rec1.t << ", t1 = " << rec2.t << std::endl;
		}
